...
{
  Book* book_product = new Book(isbn_, author_, categoryID(), prodName_, price_, qty_);
  return book_product;
}
...
{
  Clothing* clothing_prod = new Clothing(size_, brand_, "Clothing", prodName_, price_, qty_);
  return clothing_prod;
}
...
{
  Movie* movie_prod = new Movie(genre_, rating_, "Movie", prodName_, price_, qty_);
  return movie_prod;
}
